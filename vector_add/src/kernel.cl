...
uint a_local[SIZE] __attribute((xcl_array_partition(complete, 1)));
uint b_local[SIZE] __attribute((xcl_array_partition(complete, 1)));
uint out_local[SIZE] __attribute((xcl_array_partition(complete, 1)));
